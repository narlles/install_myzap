...
# Versao: 0.1
	...
	whiptail --title "Instalacao API MYZAP by OwenZap - (27 99236-9908)" --msgbox "Este é um Instalador automatico de multiplas instancia do Myzap. Aperte ENTER para iniciar a instalacao" --fb 10 70
	[[ $(whoami) != 'root' ]] && {
